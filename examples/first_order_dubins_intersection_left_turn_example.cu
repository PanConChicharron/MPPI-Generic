...
int main(int argc, char** argv)
{
  ...
  mppi::viz::drawStraightCorridor(base_frame, -105.0F, -3.0F, 55.0F, -3.0F, kCrossStreetHalfWidth);
  mppi::viz::drawStraightCorridor(base_frame, -105.0F, -4.5F, 55.0F, -4.5F, kCrossStreetHalfWidth * 0.92F);
  mppi::viz::drawStraightCorridor(base_frame, -105.0F, -5.8F, 55.0F, -5.8F, kCrossStreetHalfWidth * 0.85F);
