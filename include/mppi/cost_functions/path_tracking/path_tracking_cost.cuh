 ...
 */
 ...
 struct PathTrackingCostParams : public CostParams<DubinsBicycle::CONTROL_DIM>
 {
   ...
   {
     this->control_cost_coeff[static_cast<int>(DubinsBicycleParams::ControlIndex::ACCEL)] = 0.1F;
     this->control_cost_coeff[static_cast<int>(DubinsBicycleParams::ControlIndex::STEER)] = 0.2F;
   }
 ...
 public:
   ...
   // =============================================================================
   // CORRECT CRTP HOOKS FOR DYNAMIC SHARED MEMORY SIZING
   // =============================================================================
   
   /** * Returns the block-specific shared memory size requirements in bytes.
    * Do not use 'override' or return a vector. Return a single size_t value.
    */
   __host__ __device__ size_t getBlkSharedSizeBytes() const
   {
     return sizeof(PathTrackingCostParams<REF_HORIZON>);
   }
 
   /** Returns grid-specific shared memory size requirements in bytes. */
   __host__ __device__ size_t getGrdSharedSizeBytes() const
   {
     return 0;
   }
 };